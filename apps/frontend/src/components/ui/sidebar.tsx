...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      size="icon"
      className={cn(
        "size-7 border-none shadow-none! hover:bg-foreground/10",
        className,
      )}
      onClick={(event) => {
        onClick?.(event);
...
function SidebarMenuBadge({
  ...
  return (
    <div
      ...
      className={cn(
        "text-sidebar-foreground pointer-events-none absolute end-1 flex h-5 min-w-5 items-center justify-center rounded-md px-1 text-xs font-semibold tabular-nums select-none",
